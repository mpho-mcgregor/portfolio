...
/**
 * Sample marketplace data. Avatars use the pravatar placeholder service so the
 * app renders real images without bundling binary assets. Swap this module for
 * an API client when wiring up a backend.
 */
export const CREATIVES: Creative[] = [
  {
    id: 'c1',
    name: 'Thabo Mokoena',
    tagline: 'Weddings, portraits & lifestyle',
  ...
  },
  {
    id: 'c3',
    name: 'Aisha Patel',
    tagline: 'Bridal & editorial makeup artist',
    categoryId: 'makeup',
  ...
  },
  {
    id: 'c4',
    name: 'DJ Khaya',
    tagline: 'Amapiano, house & weddings',
    categoryId: 'music-dj',
  ...
  },
  {
    id: 'c6',
    name: 'Nomvula Zwane',
    tagline: 'Personal stylist & wardrobe curator',
    categoryId: 'fashion',
    province: 'Gauteng',
    city: 'Sandton',
  ...
  {
    id: 'c7',
    name: 'Themba Events Co.',
    tagline: 'Full-service event planning',
    categoryId: 'events',
  ...
  },
  {
    id: 'c8',
    name: 'Karabo Maleka',
    tagline: 'Contemporary African painter',
    categoryId: 'art',
    province: 'Free State',
    city: 'Bloemfontein',
  ...
  {
    id: 'c9',
    name: 'Refilwe Content',
    tagline: 'UGC & social media content',
    categoryId: 'content',
    province: 'Gauteng',
    city: 'Johannesburg',
  ...
  },
  {
    id: 'c10',
    name: 'Tshepo Films',
    tagline: 'Drone & landscape videography',
    categoryId: 'videography',
    province: 'Mpumalanga',
    city: 'Nelspruit',
  ...
  },
  {
    id: 'c11',
    name: 'Gugu Mthembu',
    tagline: 'Newborn & family photography',
    categoryId: 'photography',
    province: 'KwaZulu-Natal',
  ...
  },
  {
    id: 'c12',
    name: 'Limpopo Beats',
    tagline: 'Live band & traditional music',
    categoryId: 'music-dj',
    province: 'Limpopo',
    city: 'Polokwane',
  ...
  {
    id: 'c14',
    name: 'Kalahari Dance Crew',
    tagline: 'Performance & choreography',
    categoryId: 'dance',
  ...
  {
    id: 'c15',
    name: 'Zanele Beauty Bar',
    tagline: 'Hair, nails & makeup',
    categoryId: 'makeup',
    province: 'Free State',
    city: 'Welkom',
...
export const getCreative = (id: string): Creative | undefined =>
  CREATIVES.find((c) => c.id === id);
